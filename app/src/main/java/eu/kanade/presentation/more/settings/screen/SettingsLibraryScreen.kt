            ...
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.ListPreference(
                    ...
                    entries = persistentMapOf(
                        ...
                        1 to stringResource(MR.string.update_1hour),
                        2 to stringResource(MR.string.update_2hour),
                        3 to stringResource(MR.string.update_3hour),
                        ...
                        7 to stringResource(MR.string.update_7hour),
                        8 to stringResource(MR.string.update_8hour),
                        9 to stringResource(MR.string.update_9hour),
                        10 to stringResource(MR.string.update_10hour),
                        11 to stringResource(MR.string.update_11hour),
